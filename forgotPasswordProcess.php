...
if (isset($_GET["e"])) {
    ...
    if ($n == 1) {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'lakshan.developer1@gmail.com';
        $mail->Password = 'uupcxlgtvtzesneo';
        $mail->SMTPSecure = 'ssl';
        $mail->Port = 465;
        $mail->setFrom('lakshan.developer1@gmail.com', 'Reset Password');
        $mail->addReplyTo('lakshan.developer1@gmail.com', 'Reset Password');
